...
$paciente = new Paciente(3, "Iuri", new Cpf("376.389.456-00"), [new Telefone("86940687999")], new DateTimeImmutable("2004-06-16"), "Rua ceara, 356 ,boa esperança, Cidade Parnaíba, Piauí");

$pdoPaciente = new RepositorioPaciente();
$resposta = $pdoPaciente -> atualizarPaciente($paciente);
